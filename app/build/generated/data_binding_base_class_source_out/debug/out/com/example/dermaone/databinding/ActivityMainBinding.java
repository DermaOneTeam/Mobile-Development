...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final FloatingActionButton fabGalery;
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull FloatingActionButton fabCamera, @NonNull FloatingActionButton fabGalery,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.fab_galery;
      FloatingActionButton fabGalery = ViewBindings.findChildViewById(rootView, id);
      if (fabGalery == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, bottomAppBar, bottomNav,
          coordinatorLayout, fab, fabCamera, fabGalery, frameLayout);
    }

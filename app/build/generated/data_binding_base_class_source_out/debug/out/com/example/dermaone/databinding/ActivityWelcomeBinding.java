...
public final class ActivityWelcomeBinding implements ViewBinding {
  ...
  private ActivityWelcomeBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView ivLoginLogo,
      @NonNull View line, @NonNull MaterialButton loginBtn, @NonNull MaterialButton registerBtn,
  ...
  public static ActivityWelcomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityWelcomeBinding((ConstraintLayout) rootView, ivLoginLogo, line, loginBtn,
          registerBtn, tvDescription, tvWelcome);
    }
